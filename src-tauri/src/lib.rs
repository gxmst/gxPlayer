...
use cache_commands::{
    cache_available_keys, cache_clear, cache_export_entries, cache_list_entries, cache_list_page,
    cache_online_favorites, cache_remove_by_quality, cache_remove_entries, cache_remove_entry,
    cache_reset_directory, cache_set_directory, cache_set_limit, cache_set_online_favorite,
    cache_status, player_play_cache_entry, player_play_history_cache, preview_cache_clear,
