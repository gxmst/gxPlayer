...
Phase 0 is next: a persistent headless local playback engine plus a deliberately minimal development UI for file selection, play/pause, seek, volume, and queue progression.
